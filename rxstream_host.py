...
class rxstream_host(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, samp_rate=500000):
        ...
        self.qtgui_freq_sink_x_0.set_y_axis(-120, -60)
        ...
        self._freq_range = Range(400000000, 2500000000, 100e3, 920000000, 200)
        ...
        self.connect((self.zeromq_pull_source_0_0_0, 0), (self.qtgui_waterfall_sink_x_0, 0))    
